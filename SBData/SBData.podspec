#
# Be sure to run `pod spec lint SBData.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name         = "SBData"
  s.version      = "0.0.1"
  s.summary      = "A short description of SBData."
  # s.description  = <<-DESC
  #                   An optional longer description of SBData
  #
  #                   * Markdown format.
  #                   * Don't worry about the indent, we strip it!
  #                  DESC
  s.homepage     = "http://EXAMPLE/SBData"
  ...
  #
  # s.author       = 'Samuel Sutch', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "http://EXAMPLE/SBData.git", :tag => "0.0.1" }
